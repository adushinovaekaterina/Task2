...
namespace Лабораторная_работа__2__задание_2_
{
    ...
    {
        public static bool enterLast = false; // проверка, введена ли последовательность
                                              // цифр и нажата клавиша Enter
        public Form1()
        {
        ...
        private void Form1_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            enterLast = false; // опускаем флаг того, что введена последовательность цифр
        }
        // пункт меню, в котором описано условие задания
        private void заданиеToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Установить, является ли последовательность цифр при просмотре " +
                "их слева направо упорядоченной по возрастанию. Например, для последовательности " +
                "1,4,7,8 ответ положительный, для чисел 1,7,8,2 и 1,6,6,8 — отрицательный и т. п.");
        ...
        private void button1_Click(object sender, EventArgs e) // реакция на клик
        {
            ...
            if (Logic.Compare(continuity) != String.Empty) // если возвращаемое значение
                                                           // не является пустым сообщение-ошибкой, то
            {
